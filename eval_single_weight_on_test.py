...
def main():
    ...
    parser.add_argument("--data_root", type=str, default=r"E:/pyCharmProjects/CDD/Real/subset")
    ...
    parser.add_argument(
        "--output_path",
        type=str,
        default=r"e:/pyCharmProjects/lightMnet/ablation_runs/test_eval/single_weight_metrics.json",
    )
