...
class LightMNet(nn.Module):
    """
    Ablation variant without the hybrid attention module.
    The attention decoder is replaced with a plain segmentation head.
    """
    ...
    def __init__(self, pretrained=True):
        ...
        self.hybrid_attention = PlainSegHead(in_ch=256)
