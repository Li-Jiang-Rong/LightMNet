...
if __name__ == "__main__":
    main_with_defaults({
        ...
        "save_path": r"e:/pyCharmProjects/lightMnet/ablation_runs/weights/cdd_no_semantic_best.pth",
        "result_path": r"e:/pyCharmProjects/lightMnet/ablation_runs/results/cdd_no_semantic_result.json",
        "batch_size": 4,
        "epochs": 100,
        "lr": 5e-5,
        "weight_decay": 5e-3,
